...
def aboutDialog(self, version, year, description, title):
    ...
    print(base64.b64encode(open('./toolTitle256w_exposureValueTable.png', 'rb').read()))
    ...
    toolTitle256w_encoded = CUSTOM_TITLE
    ...
    mfxLogo_decoded = base64.b64decode(mfxLogo256w_encoded)
    toolTitle_decoded = base64.b64decode(toolTitle256w_encoded)
